...
import { useAdminLoginMutation } from "../slice/login.slice";
...
const AdminLoginPageView = () => {
  ...
  return (
    <main>
      <div className="container w-full px-2.5 md:w-[80%] mx-auto py-[55px] h-screen justify-center items-center">
        <div className="flex items-center justify-center gap-6">
          <span className="block w-[50px] h-[4px] bg-primary-color"></span>
          <h1 className="md:text-3xl text-xl font-semibold text-black-800;">
            Admin Login
          </h1>
          <span className="block w-[50px] h-[4px] bg-primary-color"></span>
        </div>

        <div className="flex items-center justify-center gap-10 md:my-[85px] my-12">
